(function() {
  var CompositeDisposable, Disposable, PropertySet, SelectorStore, Selector, _, checkValueAtKeyPath, deepClone, deepDefaults, getValueAtKeyPath, isPlainObject, parse,
    indexOf = [].indexOf;
  ...
  ({getValueAtKeyPath} = require('./key-path'));
  ...
  // Public:
  module.exports = SelectorStore = class SelectorStore {
    constructor() {
      this.cache = {};
      this.propertySets = [];
