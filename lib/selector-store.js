(function() {
  var CompositeDisposable, Disposable, PropertySet, ScopedPropertyStore, Selector, _, checkValueAtKeyPath, deepClone, deepDefaults, getValueAtKeyPath, isPlainObject, parse,
    indexOf = [].indexOf;
